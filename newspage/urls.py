from .views import HomePageView , SportPageView , SportDetailView , SportCreateView , SportUpdateView , CallMeView
from .views import TechnologyCreateView ,TechnologyPageView ,TechnologyDetailView , TechnologyUpdateView
from .views import PoliticPageView , PoliticDetailView , PoliticCreateView , PoliticUpdateView
